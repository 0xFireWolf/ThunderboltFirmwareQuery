...
public class ThunderboltFirmwareDatabase: PrettyPrintable
{
    ...
    {
        public var data: [String : ThunderboltFirmwareRecord]
        ...
        public func dump(to writer: IndentingWriter)
        {
            ...
            writer.println("## Thunderbolt 3 Firmware Database")
            
            writer.println("**This document is generated by [ThunderboltFirmwareQuery](https://github.com/0xFireWolf/ThunderboltFirmwareQuery) automatically.**  ")
            
            writer.println("**Brought to you by [FireWolf](https://www.firewolf.science/)**  ")
    ...
    ///
    public func register(records: ThunderboltFirmwareRecord, for version: String, overwrite: Bool)
    {
        self.queue.sync {
